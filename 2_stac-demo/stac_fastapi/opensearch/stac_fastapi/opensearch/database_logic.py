...
def index_by_collection_id(collection_id: str) -> str:
    """
    Translate a collection id into an Lucenia index name.
...
def mk_item_id(item_id: str, collection_id: str):
    """Create the document id for an Item in Lucenia.
...
def mk_actions(collection_id: str, processed_items: List[Item]):
    """Create Lucenia bulk actions for a list of processed items.
...
class DatabaseLogic:
    ...
    async def get_one_item(self, collection_id: str, item_id: str) -> Dict:
        ...
        Notes:
            The Item is retrieved from the Lucenia database using the `client.get` method,
